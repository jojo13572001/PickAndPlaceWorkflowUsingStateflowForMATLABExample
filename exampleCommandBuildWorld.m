...
% Copyright 2020 The MathWorks, Inc.
    ...
    % Add the obstacles for collision detection purposes 
    obs1 = collisionSphere(0.18);
    Tobs1 = trvec2tform([0.4 0.5 0.7]);
    obs1.Pose = Tobs1;
    
    obs2 = collisionSphere(0.15);
    Tobs2 = trvec2tform([0 0 0.35]);
    obs2.Pose = Tobs2;
    
    obs3 = collisionSphere(0.18);
    Tobs3 = trvec2tform([0.4 0.5 0.5]);
    obs3.Pose = Tobs3;
    
    obs4 = collisionSphere(0.18);
    Tobs4 = trvec2tform([0.4 0.5 0.3]);
    obs4.Pose = Tobs4;
    
    obs5 = collisionSphere(0.15);
    Tobs5 = trvec2tform([0 0 0.15]);
    obs5.Pose = Tobs5;
    
    coordinator.Obstacles = {obs1, obs2, obs4, obs5};    
    
    % Add the obstacles for visualization purposes
    obs1v = collisionCylinder(0.20, 0.6 );
    Tobs1v = trvec2tform([0.4 0.5 0.5]);
    obs1v.Pose = Tobs1v;
    coordinator.ObstaclesVisible = {obs1v};    
